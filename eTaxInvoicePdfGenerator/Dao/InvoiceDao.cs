...
namespace eTaxInvoicePdfGenerator.Dao
{
    class InvoiceDao
    {
        ...
        internal void save(InvoiceObj obj,bool insert)
        {
            ...
            {
                // insert
                txtQuery = string.Format("INSERT INTO {0} (invoice_id,invoice_name,purpose,issue_date,seller_id,buyer_id,tax_code,tax_rate,basis_amount,line_total,original,difference,discount,tax_total,grand_total,remark) VALUES ", this.tableName);
                string values = string.Format("(@invoice_id,@invoice_name,@purpose,@issue_date,@seller_id,@buyer_id,@tax_code,@tax_rate,@basis_amount,@line_total,@original,@difference,@discount,@tax_total,@grand_total,@remark)");
            ...
            else
            {
                ...
                string values = string.Format("invoice_name=@invoice_name,purpose=@purpose,issue_date=@issue_date,seller_id=@seller_id,buyer_id=@buyer_id,tax_code=@tax_code,tax_rate=@tax_rate,basis_amount=@basis_amount"
                    + ",line_total=@line_total,original=@original,difference=@difference,discount=@discount,tax_total=@tax_total,grand_total=@grand_total,remark=@remark ");
